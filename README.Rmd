...
This can also be see using the get_input_inclusions() function, which is useful in the case of
larger networks where the plot may be too large to iterpret easily.
```{r}
