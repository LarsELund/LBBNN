---
title: "Simulated data with non-linear effects"
...
train_lbbnn(epochs = 300, LBBNN = model_nl,
            lr = 0.01, train_dl = train_loader_nl, device = device, verbose = FALSE)
...
We see that the only the data generating features are included.